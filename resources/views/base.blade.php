      ...
      <div class="col-12">
        <nav class="navbar navbar-expand-lg  blur blur-rounded top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid">
            <a class="navbar-brand font-weight-bolder ms-sm-3"  data-placement="bottom" target="_blank">
              <img src="/Pl.png" width="50"> Perbadanan Labuan </a>
                ...
                <li class="nav-item dropdown dropdown-hover mx-2">
                  ...
                  <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                    <div class="d-none d-lg-block">
                      ...
                      <a href="/perancangan" class="dropdown-item border-radius-md">
                        <span class="ps-3">Senarai Pelan</span>
                      </a>

                      <a href="/perancangan/create" class="dropdown-item border-radius-md">
                        <span class="ps-3">Pelan Perancangan</span>
                      </a>
                    </div>
                    ...
                    <a href="/indexpengesah" class="dropdown-item border-radius-md">
                      <span class="ps-3">Senarai Pelan Yang Menunggu Pengesahan</span>
                    </a>
                    ...
                    <a href="/indexpelulus" class="dropdown-item border-radius-md">
                      <span class="ps-3">Senarai Pelan Menunggu Kelulusan</span>
                    </a>
                ...
                <li class="nav-item dropdown dropdown-hover mx-2">
                  ...
                  <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                    <div class="d-none d-lg-block">
                      ...
                      <a href="/pembekal" class="dropdown-item border-radius-md">
                        <span class="ps-3">Senarai Pembekal Berdaftar</span>
                      </a>

                      <a href="/pembekal/create" class="dropdown-item border-radius-md">
                        <span class="ps-3">Daftar Pembekal</span>
                      </a>

                      <a href="/kod" class="dropdown-item border-radius-md">
                        <span class="ps-3">Senarai Kod Bidang Berdaftar</span>
                      </a>

                      <a href="/kod/create" class="dropdown-item border-radius-md">
                        <span class="ps-3">Daftar Kod Bidang</span>
                      </a>
                    </div>
                    <div class="d-lg-none">
                      <h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center px-0">
    ...
    <div class="container">
      <div class=" row">
        <div class="col-md-3 mb-4 ms-auto">
          <div>
            <h6 class="text-gradient text-primary font-weight-bolder">ePerolehan</h6>
          </div>
          <div>
